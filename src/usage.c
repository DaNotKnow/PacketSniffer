/*
*   Este código tem como objetivo fornecer as funções de informações e uso dos programas
*/
...
void usage()
{
	printf("\nPacket Sniffer v1.0- A (very) simple packet sniffer\n"
	       "Created by Danilo P.C. <DaNotKnow@gmail.com>\n");
